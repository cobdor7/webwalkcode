...
def main():
    ...
    while True:
        ...
        cvui.text(gui, 10, 210,  'Web Width')
        cvui.trackbar(gui, 0, 230, 165, wWidth, 1, 300)
        cvui.text(gui, 10, 280,  'Antenne Width')
        cvui.trackbar(gui, 0, 300, 165, aWidth, 1, 300 , 1 )
            ...
            if check:
                ...
                if blines.any() and elines.any():
                    ...
                    try:
                        ...
                        check = False
                        #emeans = KMeans(n_clusters=1).fit(elines)
                        #bmeans = KMeans(n_clusters=1).fit(blines)
                    check = False
                    line1 = False
                    line2 = False
                    for line in flines:
                    ...
                    if check:
                        ...
                        pixGap = pixGap + abs(entroids[0,0] - entroids[1,0])
                        pixGap = pixGap + abs(entroids[0,2] - entroids[1,2])
                        pixGap = pixGap/2
